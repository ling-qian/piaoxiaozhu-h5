        ...
        <TableBody>
              ...
              <TableCell>
                <div className="flex gap-2">
                  {editingId === (item.code || item.id) ? (
                    <>
                      <Button size="sm" onClick={() => handleEdit(item.code || item.id)} aria-label="保存更改">
                        保存
                      </Button>
                      <Button size="sm" variant="outline" onClick={() => setEditingId(null)} aria-label="取消编辑">
                        取消
                      </Button>
                    </>
                  ) : (
          ...
          {isAdding && (
            <TableRow>
              ...
              <TableCell>
                <div className="flex gap-2">
                  <Button size="sm" onClick={handleAdd} aria-label="保存新项目">
                    保存
                  </Button>
                  <Button size="sm" variant="outline" onClick={() => setIsAdding(false)} aria-label="取消添加新项目">
                    取消
                  </Button>
                </div>
              </TableCell>
