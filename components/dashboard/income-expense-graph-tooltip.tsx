  ...
  return (
    ...
    >
      ...
      {incomeCategories.length > 0 && (
        <div className="mb-3">
          <h4 className="text-xs font-semibold text-green-600 mb-2 uppercase tracking-wide">按分类收入</h4>
      ...
      {expenseCategories.length > 0 && (
        <div>
          <h4 className="text-xs font-semibold text-red-600 mb-2 uppercase tracking-wide">按分类支出</h4>
          <div className="space-y-1">
