      ...
      <form action={saveAction} className="space-y-4">
        {isSelfHosted && (
          <div className="space-y-2">
            ...
            />
            <small className="text-muted-foreground">拖动提供商块来重新排序。排在最前面的优先级最高。</small>
          </div>
        )}
    ...
    >
      ...
      <div className="flex flex-row gap-4 items-center">
        <input
          ...
          placeholder={provider.baseUrlName ? "API 密钥（可选）" : "API 密钥"}
        />
        <input
          type="text"
      ...
      {provider.baseUrlName && (
        <input
          ...
          placeholder="基础 URL（例如 http://localhost:11434/v1）"
        />
      )}
      {provider.apiDoc && (
